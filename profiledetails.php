...
<link rel="stylesheet" type="text/css" href="1.css">
    ...
    <div class="register">
    <form action="profile.php"  id="register"method="post">
    ...
    <input type="email" class="a" placeholder=" Enter email" name = "gmail" ><br><br>
        ...
        <input type="number" class="a" placeholder="Enter phone number" name = "phno"><br><br>
        <label>Designation:</label><br>
    <input type="text" class="a" placeholder="  Professor" name = "designation"><br><br>
        <label>Department</label><br>
    <input type="text" class="a" placeholder="  Branch" name = "department"><br><br>
        <label>Date of Birth</label><br>
    <input type="date" class="a" name = "dob" ><br><br>
        <label>Qualifications</label><br>
    <input type="text" class="a"  placeholder=" Accomplishment" name = "qualification"><br><br>
    ...
    <input type="text" class="a b"  placeholder="subjects taught in pg" name = "pg"> <br><br>
